...
import com.maersk.apps.pageobjects.SchedulesActionBarPointToPointScreen;
...
public class SchedulesActionBarPointToPoint extends TestHarness {

	private SchedulesActionBarPointToPointScreen pointToPoint;
	protected static org.apache.log4j.Logger log = LoggerHelper.getLogger(SchedulesActionBarPointToPoint.class);

	@Given("^Tap Schedules Tab Bar$")
	public void tap_Schedules_Tab_Bar() throws Throwable {
		pointToPoint = new SchedulesActionBarPointToPointScreen(testdriver);
 ...
 public void verify_From_City_Country_Region_and_To_City_Country_Region() throws Throwable {
	...
	public void verify_Previous_Searches_Header() throws Throwable {
		Assert.assertEquals(pointToPoint.previousSearch_Header(), configProperties.getProperty("Previous.searches"),
